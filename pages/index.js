...
export default function Home() {
  ...
  const onSubmit = (data) => {
    ...
    if (imageUrlRc === "" || imageUrlRc == false) {
  ...
  function myFunctionFirstName(e) {
    if (e?.target?.value === "") {
      setfirstNameError(true);
    } else {
      setfirstNameError(false);
  ...
  function myFunctionMobile(e) {
    if (e?.target?.value === "") {
      ...
      var validRegexPh = /^\d{10}$/;
      if (validRegexPh.test(e?.target?.value)) {
        phFormatError(false);
      } else {
        phFormatError(true);
      }
  ...
  function myFunctionVechileModel(e) {
    if (e?.target?.value === "") {
      vechileModelError(true);
    } else {
      vechileModelError(false);
  ...
  function myFunctionVechileNumber(e) {
    if (e?.target?.value === "") {
      vechileNumberError(true);
    } else {
      vechileNumberError(false);
                  ...
                  <Formik>
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <div className="row rdc_form_row">
                        ...
                        <div className="rdc_form_col p-0">
                          {loader ? (
                            <div className="sweet-loading text-center p-3 mt-5">
                              {/* <ClipLoader
                             color="#ABCF39"
                             size={100}
                          ...
                          {formatImg && (
                            <div className="error-custom">
                              Supports only .jpg, .jpeg, .png, formats only
                            </div>
                          )}
                          {imageSize && (
                            <div className="error-custom">
          ...
          <div className="row das_row">
            <div className="col-lg-3">
              <div className="da_left">
                ...
                <img src="/images/dowload.svg" alt="" />
              </div>
            </div>
            <div className="col-lg-9">
              <div className="da_right">
                <div className="app_item">
                  <h2>Download the Bibbit Driver App</h2>
